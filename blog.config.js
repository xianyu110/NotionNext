...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1f1d2d4d99364b0182a4936fef28f270',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Maynor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '编程爱好者 / 互联网从业者 / 知识分享博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://maynor1024.live', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, GPT, Claude, 编程, 教程, 技术博客, Maynor', // 网站关键词 英文逗号隔开
